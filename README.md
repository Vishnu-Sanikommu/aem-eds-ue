...
## Environments
- Preview: https://main--aem-eds-ue--Vishnu-Sanikommu.aem.page/
- Live: https://main--aem-eds-ue--Vishnu-Sanikommu.aem.live/
...
1. Open the `aem-eds-ue` directory in your favorite IDE and start coding :)
